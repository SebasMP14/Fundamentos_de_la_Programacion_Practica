...
"""
Crea un módulo llamado sumatoria.py con una función 
suma_rango(inicio, fin) 
que reciba dos números y retorne la suma de todos los 
números en ese rango usando un for.
"""
